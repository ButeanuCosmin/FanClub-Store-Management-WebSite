...
<h1 style="font-size: xx-large;color: darkblue; padding-left: 20px; padding-top: 20px"><b>STAFF</b></h1>
...
<div class="card-group">
    <div class="row mb-3">
        ...
        $rezultat = mysqli_query($db, "SELECT * FROM management ");
                ...
                <div class="card bg-dark text-white">
                    <div class="zoom">
                        ...
                        <div class="text-block">
                            ...
                            <p class="card-text" style="font-size: large"><b><?php echo $row["Role"]; ?></b></p>
