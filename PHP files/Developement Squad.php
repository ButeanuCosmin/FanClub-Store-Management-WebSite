...
<div class="card-group">
    ...
    $rezultat = mysqli_query($db, "SELECT * FROM developement_squad WHERE Position ='Goalkeeper'");
    ...
    while($row = mysqli_fetch_array($rezultat))
    {
        ...
        <div class="card" style="padding-left: 20px ; width: 33%">
            <div class="card bg-dark text-white">
                <div class="zoom">
                    <img class="card-img" src="imaginiSite/<?php echo $row['Photo']; ?>" alt="Card Image" height="485px">
...
<div class="card-group">
    <div class="row mb-3">
        ...
        $rezultat = mysqli_query($db, "SELECT * FROM developement_squad WHERE Position ='Defender'");
...
<div class="card-group">
    <div class="row mb-3">
        ...
        $rezultat = mysqli_query($db, "SELECT * FROM developement_squad WHERE Position ='Midfielder'");
...
<div class="card-group">
    <div class="row mb-3">
        ...
        $rezultat = mysqli_query($db, "SELECT * FROM developement_squad WHERE Position ='Forward'");
