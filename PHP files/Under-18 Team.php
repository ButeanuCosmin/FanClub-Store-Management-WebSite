...
<div class="card-group">
    ...
    $rezultat = mysqli_query($db, "SELECT * FROM under18_team WHERE Position ='Goalkeeper'");
    ...
    while($row = mysqli_fetch_array($rezultat))
    {
        ...
        <div class="card" style="padding-left: 20px ; width: 49%">
            <div class="card bg-dark text-white">
                <div class="zoom">
                    <img class="card-img" src="imaginiSite/<?php echo $row['Photo']; ?>" alt="Card Image" width="345" height="400">
...
<div class="card-group">
    <div class="row mb-3">
        ...
        $rezultat = mysqli_query($db, "SELECT * FROM under18_team WHERE Position ='Defender'");
        ...
        while($row = mysqli_fetch_array($rezultat))
        {
            ...
            <div class="card" style="padding-left: 20px; width: 33%">
                <div class="card bg-dark text-white">
                    <div class="zoom">
                        <img class="card-img" src="imaginiSite/<?php echo $row['Photo']; ?>" alt="Card Image" height="400" width="345">
                        <div class="card-img-overlay">
                        </div>
                        <div class="text-block">
                            <h5 class="card-title" style="font-size: x-large" ><b><?php echo $row["Name"]; ?></b></h5>
...
<div class="card-group">
    <div class="row mb-3">
        ...
        $rezultat = mysqli_query($db, "SELECT * FROM under18_team WHERE Position ='Midfielder'");
...
<div class="card-group">
    <div class="row mb-3">
        ...
        $rezultat = mysqli_query($db, "SELECT * FROM under18_team WHERE Position ='Forward'");
        ...
        while($row = mysqli_fetch_array($rezultat))
        {
            ...
            <div class="card" style="padding-left: 20px; width: 98%">
                <div class="card bg-dark text-white">
                    <div class="zoom">
                        <img class="card-img" src="imaginiSite/<?php echo $row['Photo']; ?>" alt="Card Image" width="390" height="400">
                        <div class="card-img-overlay">
                        </div>
                        <div class="text-block">
                            <h5 class="card-title" style="font-size: x-large" ><b><?php echo $row["Name"]; ?></b></h5>
