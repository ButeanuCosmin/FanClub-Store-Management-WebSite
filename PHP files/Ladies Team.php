...
<div class="card-group" style="width: 66%">

    <?php



    $rezultat = mysqli_query($db, "SELECT * FROM ladies_team WHERE Position ='Goalkeeper'");
    ...
    while($row = mysqli_fetch_array($rezultat))
    {
        ...
        <div class="card" style="padding-left: 20px ; width: 33%">
            <div class="card bg-dark text-white">
                <div class="zoom">
                    <img class="card-img" src="imaginiSite/<?php echo $row['Photo']; ?>" alt="Card Image" height="370" width="500" >
                    <div class="card-img-overlay">
                    </div>
                    <div class="text-block" style="color: #000;">
...
<div class="card-group">
    <div class="row mb-3">
        ...
        $rezultat = mysqli_query($db, "SELECT * FROM ladies_team WHERE Position ='Defender'");
...
<div class="card-group">
    <div class="row mb-3">
        ...
        $rezultat = mysqli_query($db, "SELECT * FROM ladies_team WHERE Position ='Midfielder'");
...
<div class="card-group">
    <div class="row mb-3">
        ...
        $rezultat = mysqli_query($db, "SELECT * FROM ladies_team WHERE Position ='Forward'");
