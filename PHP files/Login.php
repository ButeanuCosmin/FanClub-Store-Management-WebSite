                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form name="form1" action="" id="forma" method="post">
                            ...
                            <input type="submit" name="trimitelog" class="btn btn-primary btn-block" value="Login">

                            <p style="margin-top:20px;">You are not a member yet ? <a href="Register.php">Register here</p>
                        </form>
                    </div>
                </div>
            </div>
...
if(isset($_POST["trimitelog"])){
    ...
    $result = mysqli_query($db, "SELECT * FROM users WHERE username = '$_POST[user]' and pass = '$_POST[parola]'");
